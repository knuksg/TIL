...
```python
for data in Movie.objects.all().filter(screening=True).order_by('opening_date'):
    print(data.director.name, data.genre.title, data.title, data.opening_date, data.running_time, data.screening)
```
...
```python
for data in Movie.objects.all().filter(director_id=Director.objects.get(name='봉준호')).order_by('opening_date'):
    print(data.director.name, data.genre.title, data.title, data.opening_date, data.running_time, data.screening)
```
...
```python
data = Movie.objects.all().filter(director_id=Director.objects.get(name='봉준호')).order_by('opening_date')[1]
print(data.director.name, data.genre.title, data.title, data.opening_date, data.running_time, data.screening)
```
...
```python
for data in Movie.objects.all().filter(running_time__gt=119).order_by('running_time'):
    print(data.director.name, data.genre.title, data.title, data.opening_date, data.running_time, data.screening)
```
...
```python
for data in Movie.objects.all().filter(running_time__gte=119).order_by('running_time'):
    print(data.director.name, data.genre.title, data.title, data.opening_date, data.running_time, data.screening)
...
```python
for data in Movie.objects.all().filter(opening_date__gte='2022-01-01').order_by('opening_date'):
    print(data.director.name, data.genre.title, data.title, data.opening_date, data.running_time, data.screening)
```
...
```python
for data in Movie.objects.all().filter(director=Director.objects.get(name='봉준호'), genre=Genre.objects.get(title='드라마')).order_by('opening_date'):
    print(data.director.name, data.genre.title, data.title, data.opening_date, data.running_time, data.screening)
```
